  ...
  return (
    <>
      <section className="overflow-hidden px-4 sm:px-6 mt-10 sm:flex sm:flex-col gap-4 md:justify-center md:items-center">
        ...
        <div className="sm:w-full w-[750px] flex justify-center items-center relative sm:ml-0 ml-[-50px] md:mt-[-90px] mt-[-40px]">
          <Image src={Banner} alt="application-banner" />
          <div className="bottom-0 top-[50%] bg-gradient-to-t dark:from-background left-0 right-0 absolute z-10"></div>
        </div>
      </section>
      <section className="relative">
        <div className="overflow-hidden flex after:content[''] after:dark:from-brand-dark after:to-transparent after:from-background after:bg-gradient-to-l after:right-0 after:bottom-0 after:top-0 after:w-20 after:z-10 after:absolute before:content[''] before:dark:from-brand-dark before:to-transparent before:from-background before:bg-gradient-to-r before:right-0 before:bottom-0 before:top-0 before:absolute before:w-20 before:z-10">
          {[...Array(2)].map((arr) => (
            <div
              key={arr}
      ...
      <section className="px-4 sm:px-6 flex justify-center items-center flex-col relative">
        <div className="w-[30%] blur-[120px] rounded-full h-32 absolute bg-brand-primaryPurple/50 -z-10 top-10" />
        <TitleSection
      ...
      <section className="relative">
        <div className="w-full blur-[120px] rounded-full h-32 absolute bg-brand-primaryPurple/50 -z-10 top-40" />
      ...
      <section className="mt-20 px-4 sm:px-6">
        <TitleSection
          ...
          subheading="Experience all the benefits of our platform. Select a plan that suits your need and take your productivity to new heights"
          pill="Pricing"
        />
