  ...
  return (
    <header className="p-4 flex justify-center items-center">
      <Link href={"/"} className="w-full flex justify-start items-center">
        <Image src={Logo} alt="TeamDocs logo" width={25} height={25} />
        <span className="font-semibold dark:text-white">TeamDocs</span>
      </Link>
      ...
      <aside className="flex w-full gap-2 justify-end ">
        ...
        <Link href={"/auth/signup"}>
          <Button className="hidden sm:block whitespace-nowrap">Sign Up</Button>
        </Link>
      </aside>
    </header>
  );
